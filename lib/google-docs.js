...
class GoogleDocsClient {
  ...
  async copyTemplate(templateId, newTitle, folderId = null) {
    try {
      ...
      // Step 2: Create metadata for new document with owner set
      ...
      // Step 4: Transfer ownership if email provided
      if (ownerEmail) {
        ...
        try {
          ...
          console.warn('Could not transfer ownership:', error.message);
        }
      }
